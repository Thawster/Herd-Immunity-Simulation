...
#     with open('test_log.txt', 'r') as f:
#         val = f.read()
#         assert val == "1 didn't infect 2 because they are already sick."
#
#     os.remove('test_log.txt')
...
def test_log_interaction_second_case():
    ...
    with open('test_log.txt', 'r') as f:
        val = f.read()
        assert  val == "1 didn't infect 2 because they are already vaccinated."
...
#     with open('test_log.txt', 'r') as f:
#         val = f.read()
#         assert '1 survived infection.' in val
#
#     os.remove('test_log.txt')
#
#
